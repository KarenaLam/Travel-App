  ...
  return (
    ...
    py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-[color:#30AF5B] p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl
        xl:p-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
            <strong>Feeling Lost</strong> And Not Knowing the Way?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Starting from the anxiety of the climbers when visiting a new climbing location, the possibilty
